        ...
        <section class="login-box">
            <div class="login-container">
                <div class="login-image">
                    <img src="images/login_photo.gif" alt="Login Image">
                </div>
                <div class="login">
                    <h2>STUDENT LOGIN</h2>
                    <form method="post" class="form" enctype="multipart/form-data">
                        ...
                        <div class="forgot">
                            <p><a href="student_change.py">Change password?</a></p>
                            <p><a href="student_forgot.py">Forgot password?</a></p>
                        </div>
                        <div class="submit">
...
if Submit != None :
    ...
    q="""SELECT id FROM student_login WHERE username='%s' AND password='%s'"""%(Username,Password)
    cur.execute(q)
    rec = cur.fetchone()
