...
<body>
    ...
    <h1 style=text-align:center;>Semester 7</h1>
...
if Submit != None:
    ...
    if (res == None):
        ...
        print("""
            <script>
             alert("Semester 7 Form Filled Successfully !");
    ...
    if (res != None):
        ...
        print("""
                    <script>
                     alert("Semester 7 Form Updates Successfully !");
                     location.href='student_main.py?id=%s'
                    </script>    
                    """ % Regno)
