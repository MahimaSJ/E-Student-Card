...
<body>
    ...
    <h1 style=text-align:center;>Semester 1</h1>
...
if Submit != None :
    ...
    if(res==None):
        ...
        print("""
            <script>
             alert("Semester 1 Form Filled Successfully !");
    ...
    if(res!=None):
        ...
        print("""
                    <script>
                     alert("Semester 1 Form Updates Successfully !");
                     location.href='student_main.py?id=%s'
                    </script>    
                    """ % Regno)
