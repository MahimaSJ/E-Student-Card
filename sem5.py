...
<body>
    ...
    <h1 style=text-align:center;>Semester 5</h1>
...
if Submit != None:
    ...
    if (res == None):
        ...
        print("""
            <script>
             alert("Semester 5 Form Filled Successfully !");
    ...
    if (res != None):
        ...
        print("""
                    <script>
                     alert("Semester 5 Form Updates Successfully !");
                     location.href='student_main.py?id=%s'
                    </script>    
                    """ % Regno)
