...
<body>
    ...
    <h1 style=text-align:center;>Semester 8</h1>
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <div class="summary">
                ...
                <input type="number" step="0.01" id="gpa" name="gpa" value="{result[54]}" required>
                 ...
                 <h3 style="text-align:center">Scholarship Details : Year 4 (If Any)</h3>
...
if Submit != None:
    ...
    if (res == None):
        ...
        if rec != None:
            ...
            q = """UPDATE scholarship_details SET name4='%s' AND amount4='%s' WHERE register_no='%s'""" % (
                ScholarshipName, ScholarshipAmount, Regno)
            cur.execute(q)
            con.commit()

        else:
            q = """INSERT INTO scholarship_details(register_no,name4,amount4) VALUES ('%s','%s','%s')""" % (
        ...
        print("""
            <script>
             alert("Semester 8 Form Filled Successfully !");
    ...
    if (res != None):
        ...
        print("""
                    <script>
                     alert("Semester 8 Form Updates Successfully !");
                     location.href='student_main.py?id=%s'
                    </script>    
                    """ % Regno)
