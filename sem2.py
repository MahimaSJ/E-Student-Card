        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <div class="summary">
                ...
                <input type="number" step="0.01" id="gpa" name="gpa" value="{result[54]}" required>
                 ...
                 <h3 style="text-align:center">Scholarship Details : Year 1 (If Any)</h3>
                
                <label for="scholarship_name">Scholarship Name:</label>
                <input type="text"  id="scholarship_name" name="scholarship_name" value="{sch[3]}">
                
                <label for="scholarship_amount">Scholarship Amount:</label>
                <input type="text"  id="scholarship_amount" name="scholarship_amount" value="{sch[4]}" >
...
if Submit != None:
    ...
    if (res == None):
        ...
        q = """INSERT INTO scholarship_details(register_no,name1,amount1) VALUES('%s','%s','%s'""" % (Regno,ScholarshipName,ScholarshipAmount)
        cur.execute(q)
        rec = cur.fetchone()

        print("""
            <script>
             alert("Semester 2 Form Filled Successfully !");
    ...
    if (res != None):
        ...
        q = """UPDATE scholarship_details SET name1='%s' AND amount1='%s' WHERE register_no='%s'""" % (
        ...
        print("""
                    <script>
                     alert("Semester 2 Form Updates Successfully !");
                     location.href='student_main.py?id=%s'
                    </script>    
                    """ % Regno)
